...
| `error MSB4024: An XML comment cannot contain '--'` | A comment in `Directory.Build.props` contained `--force-evaluate`. | XML comments cannot contain a double hyphen. Reword. |
